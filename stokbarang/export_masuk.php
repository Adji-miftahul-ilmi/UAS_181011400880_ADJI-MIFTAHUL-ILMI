...
$(document).ready(function() {
    ...
    $('#dataTable').DataTable({
        ...
        buttons: [
            {
                extend: 'copy',
                title: 'Laporan Data Barang Masuk ' + formattedDate,
                messageTop: '' 
            },
            {
                extend: 'csv',
            ...
            },
            {
                extend: 'pdf',
                  ...
                  customize: function (doc) {
                    ...
                    doc.content.splice(2, 0, {
                      text: [
                        { text: 'Laporan Data Barang Masuk\n', fontSize: 12, bold: true },
                ...
                },
                {
                  ...
                  messageTop: function () {
                    ...
                    '<span style="font-weight: bold; font-size: 12px;">Laporan Data Barang Masuk</span><br>' +
