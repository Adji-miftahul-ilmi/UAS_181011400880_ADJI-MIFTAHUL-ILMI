      ...
      <div class="container">
        <div class="table-container">
          ...
          <div class="report-header">
            <h5>Laporan Data Stock Barang</h5>
            <p id="tanggal"></p>
            <p id="waktu"></p>
          </div>
          ...
          $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
              ...
              buttons: [
                {
                  extend: 'copy',
                  title: 'Laporan Data Stock Barang Masuk ' + formattedDate,
                  messageTop: ''
                },
                {
                  extend: 'csv',
                ...
                },
                {
                  ...
                  customize: function (doc) {
                    ...
                    doc.content.splice(2, 0, {
                      text: [
                        { text: 'Laporan Data Stock Barang\n', fontSize: 12, bold: true },
                ...
                },
                {
                  ...
                  messageTop: function () {
                    ...
                    '<span style="font-weight: bold; font-size: 12px;">Laporan Stock Barang</span><br>' +
